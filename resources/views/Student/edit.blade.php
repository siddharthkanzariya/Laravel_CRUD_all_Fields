<html>
    ...
    <body>
        <form method="post" action="{{route('student.update',$studentdata->id)}}" enctype="multipart/form-data">
            @csrf
            @method('PATCH')
            <table align="center">
                <tr>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        RoadTrip : <input type="checkbox" name="st_hobby[]" value="roadtrip"
                            {{in_array('roadtrip',$array) ? 'checked' : ''}}>
                    </td>
                </tr>
                <tr>
                    <td>Mobile</td>
                ...
                <tr>
                    <td>Address</td>
                    <td>
                        <textarea name="address" value="{{$studentdata->st_address}}"></textarea>
                    </td>
                </tr>
                <tr>
                    <td>Image</td>
                ...
                <tr>
                    <td><img src="{{asset('uploads/'.$studentdata->st_image)}}" width="80"></td>
                </tr>
                <tr>
                    <td>
